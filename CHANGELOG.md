...
- Datapath register separation.
- Address shift register (`shift_reg`).
- Address bit counter (`bit_cnt`).

### Changed

- Integrated clock divider with the complete bus engine.
- Refactored RTL into separate State Register, Datapath Register, Next-State Logic, and Output Logic.
- Expanded the self-checking verification environment.
